...
def parse_args():
    ...
    arg_parser.add_argument('-g', '--generations', type=int, default=500,
...
if __name__ == '__main__':
    ...
    machines, jobs = parse_file("./test_data.txt")
    # [1.0, 1.2, 1.5] [50, 75, 60]
    create_lookup_table(machines, jobs)
    # lookup_table : [[50.0, 60.0, 75.0], [75.0, 90.0, 112.5], [60.0, 72.0, 90.0]]
